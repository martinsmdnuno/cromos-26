...
export const en: Dict = {
  ...
  'pack.hint': 'Type, paste, or snap a photo of the sticker backs. Spaces, commas or new lines all work.',
  ...
  'pack.photo_aria': 'Scan a photo of sticker backs',
  'pack.photo_title': 'Scan a photo',
  'pack.photo_uploading': 'Uploading photo…',
  'pack.photo_analyzing': 'Reading photo…',
  'pack.photo_none_found': 'No sticker codes recognised. Try a sharper or closer photo.',
  'pack.photo_error_generic': 'Could not read this photo. Please try again.',
  ...
  'trades.register': 'Register this trade',
  'trade.title': 'TRADE STICKERS',
  'trade.hint': 'List the duplicates you give and (optionally) the ones you get back. Your collection updates in one go.',
  'trade.give_label': 'I GIVE',
  'trade.receive_label': 'I RECEIVE',
  'trade.optional': '(optional)',
  'trade.not_owned': "You don't have this one — it won't change.",
  'trade.loses_last': "You'll no longer have this sticker.",
  'trade.submit': 'GIVE {give} · GET {receive}',
  'trade.submit_empty': 'NOTHING TO TRADE',
...
export const pt: Dict = {
  ...
  'pack.hint': 'Escreve, cola ou tira foto às costas dos cromos. Espaços, vírgulas ou novas linhas servem.',
  'pack.placeholder': 'POR1 POR3 MEX12 FWC14 245',
  ...
  'pack.photo_aria': 'Ler foto das costas dos cromos',
  'pack.photo_title': 'Ler foto',
  'pack.photo_uploading': 'A enviar foto…',
  'pack.photo_analyzing': 'A ler foto…',
  'pack.photo_none_found': 'Nenhum código reconhecido. Tenta uma foto mais nítida ou mais próxima.',
  'pack.photo_error_generic': 'Não consegui ler esta foto. Tenta novamente.',
  ...
  'trades.register': 'Registar esta troca',
  'trade.title': 'TROCAR CROMOS',
  'trade.hint': 'Lista os repetidos que dás e (opcionalmente) os que recebes. A tua coleção é atualizada de uma só vez.',
  'trade.give_label': 'DOU',
  'trade.receive_label': 'RECEBO',
  'trade.optional': '(opcional)',
  'trade.not_owned': 'Não tens este — não vai mudar.',
  'trade.loses_last': 'Vais ficar sem este cromo.',
  'trade.submit': 'DAR {give} · RECEBER {receive}',
  'trade.submit_empty': 'NADA PARA TROCAR',
