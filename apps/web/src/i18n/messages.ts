...
export const en: Dict = {
  ...
  'pack.hint': 'Type or paste sticker codes. Spaces, commas or new lines all work.',
...
export const pt: Dict = {
  ...
  'pack.hint': 'Escreve ou cola códigos de cromos. Espaços, vírgulas ou novas linhas servem.',
  'pack.placeholder': 'POR1 POR3 MEX12 FWC14 245',
