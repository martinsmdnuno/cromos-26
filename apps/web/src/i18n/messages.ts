...
export const en: Dict = {
  ...
  'pack.hint': 'Type, paste or use the mic. Spaces, commas or new lines all work.',
  ...
  'pack.mic_start': 'Speak the codes',
  'pack.mic_stop': 'Stop listening',
  'pack.mic_start_aria': 'Start voice input',
  'pack.mic_stop_aria': 'Stop voice input',
  'pack.mic_listening': 'Listening… say e.g. "P O R one, P O R three, F W C fourteen"',
  'pack.mic_error': 'Microphone error: {err}',
...
export const pt: Dict = {
  ...
  'pack.hint': 'Escreve, cola ou usa o microfone. Espaços, vírgulas ou novas linhas servem.',
  'pack.placeholder': 'POR1 POR3 MEX12 FWC14 245',
  ...
  'pack.mic_start': 'Ditar os códigos',
  'pack.mic_stop': 'Parar de ouvir',
  'pack.mic_start_aria': 'Começar entrada por voz',
  'pack.mic_stop_aria': 'Parar entrada por voz',
  'pack.mic_listening': 'A ouvir… diz por exemplo "P O R um, P O R três, F W C catorze"',
  'pack.mic_error': 'Erro do microfone: {err}',
